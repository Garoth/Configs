" Andrei Thorp's Theme, based on Airline Murmur
let g:airline#themes#athorp#palette = {}
...
let s:cterm_termbg2   = 27   " Background for middle block
...
let s:cterm_normalfg  = 7   " Foreground for normal mode and file position blocks
...
let s:cterm_insertfg  = 7   " Foreground for insert mode and file position blocks
...
let s:cterm_inactivefg = 246 " Foreground for inactive mode
...
let g:airline#themes#athorp#palette.normal = airline#themes#generate_color_map(s:N1, s:BB, s:N2)
let g:airline#themes#athorp#palette.normal_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}

" Insert mode
let s:I1 = [s:gui_insertfg, s:gui_insertbg, s:cterm_insertfg, s:cterm_insertbg] " Outside blocks in insert mode
let s:I2 = [s:gui_insertbg, s:gui_termbg2, s:cterm_insertfg, s:cterm_insertbg]   " Middle block
let g:airline#themes#athorp#palette.insert = airline#themes#generate_color_map(s:I1, s:BB, s:I2)
let g:airline#themes#athorp#palette.insert_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#athorp#palette.replace = airline#themes#generate_color_map(s:R1, s:BB, s:R2)
let g:airline#themes#athorp#palette.replace_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}

" Visual mode
let s:V1 = [s:gui_visualfg, s:gui_visualbg, s:cterm_visualfg, s:cterm_visualbg] " Outside blocks in visual mode
let s:V2 = [s:gui_visualbg, s:gui_termbg2, s:cterm_visualfg, s:cterm_visualbg]   " Middle block
let g:airline#themes#athorp#palette.visual = airline#themes#generate_color_map(s:V1, s:BB, s:V2)
let g:airline#themes#athorp#palette.visual_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#athorp#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

" CtrlP plugin colors
if !get(g:, 'loaded_ctrlp', 0)
  finish
endif
let g:airline#themes#athorp#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
